...
public class LifecycleActivity extends FragmentActivity {
    ...
    /**
     * Called when this activity instance is terminating either because of an app close or restart request. This method will be called on each activity in the
     * stack.
     * 
     * @param data
     */
