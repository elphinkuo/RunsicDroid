package com.runningmusic.behavior;
...
/**
 * Created by guofuming on 11/4/16.
 */
public class FloatingBehavior extends CoordinatorLayout.Behavior<LinearLayout> {
    ...
    public FloatingBehavior(Context context, AttributeSet attrs) {
        ...
        public boolean layoutDependsOn(CoordinatorLayout parent,
                                       LinearLayout child, View dependency) {
...
//            return true;
        ...
        private void updateFabTranslationForSnackbar(CoordinatorLayout parent,
                                                     final LinearLayout fab, View snackbar) {
