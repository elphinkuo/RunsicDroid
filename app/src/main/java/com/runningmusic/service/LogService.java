...
public class LogService extends Service {
	...
	private void init() {
		...
		LOG_PATH_SDCARD_DIR = Environment.getExternalStorageDirectory().getAbsolutePath() + File.separator + "runsic" + File.separator + "log";
		createLogDir();
	...
	private PartialWakeLock wakeLock = new PartialWakeLock("LogService");
	...
	class LogCollectorThread extends Thread {
		...
		public void run() {
			try {
				// 唤醒手机
				wakeLock.acquireWakeLock(Util.context());
				clearLogCache();
	...
	public void createLogCollector() {
		...
		// commandList.add("BatchDataManager:V");
		// commandList.add("RunsicService:V");
		commandList.add("QQ_HEALTH:V");
