...
import static com.runningmusic.videocache.Preconditions.checkArgument;
...
public class ProxyCacheUtils {
    ...
    public static String computeMD5(String string) {
        try {
            ...
            Log.e(LOG_TAG, "before MD% time is " + Debug.threadCpuTimeNanos());
            byte[] digestBytes = messageDigest.digest(string.getBytes());
            Log.e(LOG_TAG, "after MD% time is " + Debug.threadCpuTimeNanos());
